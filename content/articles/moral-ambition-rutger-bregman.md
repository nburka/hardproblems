...
articleType: 'Book reviews' # Article | Book reviews | Podcast
...
We like this book as a clarion call for people with skills, like designers and technologists, to do _something_ to change the world for the better. For those of us who are still thinking about how to orient our careers around impact, there are important lessons we can learn through Bregman's analysis:
...
## If you're starting to question the impact of your work, you aren't alone {#if-youre-starting-to-question-the-impact-of-your-work-you-arent-alone}
...
## Yes, individuals can change the course of history {#yes-individuals-can-change-the-course-of-history}

Happily for us, individual actors _can_ make a difference. Throughout the book, we're introduced to a cast of characters that embody Bregman's conception of moral ambition: People like [Rosa Parks](https://en.wikipedia.org/wiki/Rosa_Parks) for her role in the US Civil Rights movement, [Thomas Clarkson](https://en.wikipedia.org/wiki/Thomas_Clarkson) for his work to abolish slavery, and [Ralph Nader](https://en.wikipedia.org/wiki/Ralph_Nader) for landmark legal changes for protecting the environment and product safety. Bregman helpfully tells each of their histories and, as a reader, you can see how you might follow in their footsteps. What's surprisingly remarkable is how unremarkable each of these people are — they were normal(ish) people who felt compelled to take action and found a leverage point to succeed. It's inspiring that you might be able to have such impact too.
