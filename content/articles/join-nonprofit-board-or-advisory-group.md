...
articleType: 'Advice' # Article | Book Review | Podcast | Opinion | Advice
...
image: '/images/content/thumb-board-and-advisory-roles.jpg'
imageAlt: 'Designers and nonprofit leaders meeting around a boardroom table'

seoTitle: 'How to Join a Nonprofit Board or Advisory Group as a Senior Designer'
seoDescription: 'How senior designers and product leaders can find, join, and contribute to nonprofit boards and advisory groups — and use the role as a path to full-time impact work.'
...
As my friend [Desigan](https://uk.linkedin.com/in/desiganchinniah) points out, it would be better for inclusion if more board roles went through an open process (like a hiring process), but realistically that's unfortunately uncommon. However, there are some organizations that connect candidates to open board positions. [Sam Nguyen](https://www.linkedin.com/in/sampng/) told me about [Reach Volunteering](https://reachvolunteering.org.uk/), a group in the UK that connects volunteers with charities. Sam joined the board of [Resonate Arts](https://www.linkedin.com/company/resonatearts/) this way and speaks highly of Reach Volunteering. I don't personally have experience with any of these but similar orgs exist in other countries: [Catchafire](https://www.catchafire.org) (USA), [VolunteerMatch](https://www.idealist.org/volunteermatch) (USA), [MovingWorlds](https://movingworlds.org/) (Global), [GoVolunteer](https://govolunteer.com.au/) (Australia), [Volunteer Canada](https://volunteer.ca/), and [Volunteering New Zealand](https://www.volunteeringnz.org.nz/).
...
## An advisory group is another way to contribute {#what-is-an-advisory-group}
...
## A path to full-time work on a hard problem {#a-path-to-full-time-work-on-a-hard-problem}
...
### "Lived experience is my greatest contribution"

[Fred Hersch](https://www.linkedin.com/in/fredhersch/) who is the product lead for social impact at Google's [DeepMind](https://deepmind.google/) told me: "My greatest contribution to a charity are my graying hairs i.e. the lived experience ;) and being able to bring in ideas from different fields. For example, how we think about innovation or goal setting in the tech sector. At the end of the day, the board's role is to work with the management team to set the strategy and then support the executive team to deliver. The main contribution is being able to be a sounding board, provide some guidance when asked and to help create the space to allow the team to work through whatever challenges they are trying to solve."
