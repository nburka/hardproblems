...
A typical advisory board meeting will give the group an overview of what happened in the last quarter and what is coming up. Then, the leaders will ask the advisory board members for feedback and input on key issues. For instance, Our Future Health was recently considering how to re-engage their audience with real health data that was collected when people joined the program, so the advisory board debated data security around health data, ethics of sharing personal health data back to individuals, and the user experience of re-engaging people who hadn't heard from the organization in over a year. It was a lively conversation.

Just like a board, there often isn't a clear pathway to joining an advisory group. Connections are the key. Network, be useful, and put yourself out there. An advisory board position can also be a stepping stone to joining a board, if you want it to be.
