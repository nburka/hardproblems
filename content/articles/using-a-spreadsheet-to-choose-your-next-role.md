...
1. I was leaving my first company, [silverorange](https://silverorange.com), after seven years and moving to California to try my hand in Silicon Valley — I spent the next five years as the director of design at [Digg.com](http://digg.com).
2. I was leaving a successful Silicon Valley social media startup after five years and choosing my next move — I joined a gaming startup called [Glitch](<https://en.wikipedia.org/wiki/Glitch_(video_game)>) that later became [Slack](https://slack.com).
3. I had sold a company to Google, spent five years at [Google Ventures](https://gv.com) as a design partner and was trying to imagine a role that had more positive impact on the world — I spent the next eight years at a global public health charity called [Resolve to Save Lives](https://rtsl.org), working on tools for healthcare workers to manage patients with hypertension, the biggest killer in the world.
...
Here's a quick-start guide to the framework.
