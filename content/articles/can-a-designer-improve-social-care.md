---
title: 'Can a designer improve social care?'
slug: 'can-a-designer-improve-social-care'

excerpt: "Naomi Owolabi, founder of Grene, is using design to tackle one of adult social care's biggest burdens: the paperwork that quietly pushes great managers out of the industry."
...
image: '/images/content/thumb-grene-naomi-owolabi.jpg'
imageAlt: 'Naomi Owolabi, founder of Grene, at the Hard Problems coworking space'

seoTitle: 'Can a Designer Improve Social Care? An Interview with Naomi Owolabi'
seoDescription: "Grene founder Naomi Owolabi on using design to solve one of adult social care's biggest burdens — the paperwork that pushes great managers out of the industry."

canonicalUrl: ''
---

# Can a designer improve social care? {#can-a-designer-improve-social-care}

_We sit down with [Naomi Owolabi](https://www.linkedin.com/in/owolabinaomi/), founder of [Grene](https://grene.co.uk), to discuss how she's using design to solve one of social care's biggest challenges._{.intro}

![Naomi Owolabi, founder of Grene](/images/content/image-grene.png){.float-right}
...
With the costs of social care set to balloon across Europe and the United States, there is a real opportunity for companies like Grene to make an impact. In England, adult social care [contributed £77.8 billion to the economy in 2024-25](https://www.skillsforcare.org.uk/news-and-events/news/latest-social-care-sector-and-workforce-data-published), and the sector currently employs more than [1.5 million people](https://www.kingsfund.org.uk/insight-and-analysis/data-and-charts/key-facts-figures-adult-social-care). "Social care is very overlooked," Naomi observes, but "'moving fast and breaking things' is not going to work." Instead, progress depends on patience, trust, and a continued desire to solve hard problems. Fortunately for us, Naomi seems to be just getting started.
